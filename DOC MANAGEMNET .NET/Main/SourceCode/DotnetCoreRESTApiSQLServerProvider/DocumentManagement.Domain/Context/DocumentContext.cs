...
namespace DocumentManagement.Domain
{
    public class DocumentContext : IdentityDbContext<User, Role, Guid, UserClaim, UserRole, UserLogin, RoleClaim, UserToken>
    {
        ...
        public DbSet<DesginationUserMstTable> DesginationUserMstTable { get; set; }
        public DbSet<UserRoleMstTable> UserRoleMstTable { get; set; }
        public DbSet<ArchiveDocument> ArchiveDocument { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<DesginationUserMstTable>().ToTable("XStudio_Designation_User_Mst_Tbl");
            builder.Entity<UserRoleMstTable>().ToTable("XStudio_UserRole_Mst_Tbl");
            //builder.Entity<ArchiveDocument>().ToTable("ArchiveDocument");
