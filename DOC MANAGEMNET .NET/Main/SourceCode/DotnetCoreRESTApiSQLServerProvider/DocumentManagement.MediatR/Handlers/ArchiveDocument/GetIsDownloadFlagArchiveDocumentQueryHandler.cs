...
{
    public class GetIsDownloadFlagArchiveDocumentQueryHandler : IRequestHandler<GetIsDownloadFlagArchiveDocumentQuery, bool>
    {
        ...
        public GetIsDownloadFlagArchiveDocumentQueryHandler(IDocumentRolePermissionRepository documentRolePermissionRepository,
            IMapper mapper,
        ...
        public async Task<bool> Handle(GetIsDownloadFlagArchiveDocumentQuery request, CancellationToken cancellationToken)
        {
