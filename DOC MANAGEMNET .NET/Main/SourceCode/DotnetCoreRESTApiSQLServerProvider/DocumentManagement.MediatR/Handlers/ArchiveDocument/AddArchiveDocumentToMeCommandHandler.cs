...
{
    public class AddArchiveDocumentToMeCommandHandler : IRequestHandler<AddArchiveDocumentToMeCommand, ServiceResponse<ArchiveDocumentDto>>
    {
        ...
        public AddArchiveDocumentToMeCommandHandler(
        ...
        public async Task<ServiceResponse<ArchiveDocumentDto>> Handle(AddArchiveDocumentToMeCommand request, CancellationToken cancellationToken)
        {
