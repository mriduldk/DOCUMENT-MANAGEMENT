...
namespace DocumentManagement.API.Controllers
{
    ...
    public class ArchiveDocumentController : BaseController
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet("ArchiveDocument/{id}", Name = "ArchiveGetDocument")]
        [Produces("application/json", "application/xml", Type = typeof(ArchiveDocumentDto))]
        public async Task<IActionResult> GetArchiveDocument(Guid id)
        {
            var getDocumentQuery = new GetArchiveDocumentQuery
            {
                Id = id
            };
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet("ArchiveDocument/View/{id}", Name = "GetArchiveDocumentView")]
        [Produces("application/json", "application/xml", Type = typeof(ArchiveDocumentDto))]
        public async Task<IActionResult> GetArchiveDocumentView(Guid id)
        {
            var getDocumentByIdQuery = new GetArchiveDocumentByIdQuery
            {
                Id = id
            };
        ...
        /// <returns></returns>
        [HttpGet("ArchiveDocuments")]
        [Produces("application/json", "application/xml", Type = typeof(ArchiveDocumentList))]
        public async Task<IActionResult> GetArchiveDocuments([FromQuery] DocumentResource documentResource)
        {
            var getAllDocumentQuery = new GetAllArchiveDocumentQuery
            {
        ...
        /// <returns></returns>
        [HttpPost("ArchiveDocument")]
        [Produces("application/json", "application/xml", Type = typeof(ArchiveDocumentDto))]
        public async Task<IActionResult> AddArchiveDocument(AddArchiveDocumentCommand addDocumentCommand)
        {
            ...
            return CreatedAtAction("GetArchiveDocument", new { id = result.Data.Id }, result.Data);
        }

        [HttpPost("ArchiveDocument/assign")]
        [Produces("application/json", "application/xml", Type = typeof(ArchiveDocumentDto))]
        public async Task<IActionResult> AddArchiveDocumentToMe(AddArchiveDocumentToMeCommand addDocumentCommand)
        {
            var result = await _mediator.Send(addDocumentCommand);
            if (!result.Success)
            {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost("ArchiveDocument/upload"), DisableRequestSizeLimit]
        public async Task<IActionResult> UploadFile()
        {
            try
            {
                ...
                string folderName = "ArchiveDocuments";
        ...
        /// <returns></returns>
        [HttpPut("ArchiveDocument/{Id}")]
        [Produces("application/json", "application/xml", Type = typeof(ArchiveDocumentDto))]
        public async Task<IActionResult> UpdateArchiveDocument(Guid Id, UpdateArchiveDocumentCommand updateDocumentCommand)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        [HttpDelete("ArchiveDocument/{Id}")]
        public async Task<IActionResult> DeleteArchiveDocument(Guid Id)
        {
            var deleteDocumentCommand = new DeleteArchiveDocumentCommand
            {
                Id = Id
            };
        ...
        [HttpGet("ArchiveDocument/{id}/download")]
        public async Task<IActionResult> DownloadArchiveDocument(Guid id)
        {
            var commnad = new DownloadArchiveDocumentCommand
            {
                Id = id,
            };
        ...
        [HttpGet("ArchiveDocument/{id}/officeviewer")]
        [AllowAnonymous]
        public async Task<ActionResult> GetArchiveDocumentFileByToken(Guid id, Guid token, bool isVersion)
        {
        ...
        [HttpGet("ArchiveDocument/{id}/isDownloadFlag")]
        [AllowAnonymous]
        public async Task<ActionResult> GetIsDownloadFlagArchiveDocument(Guid id)
        {
            var deleteDocumentTokenCommand = new GetIsDownloadFlagArchiveDocumentQuery
            {
                DocumentId = id,
            };
            var result = await _mediator.Send(deleteDocumentTokenCommand);
        ...
        /// <returns></returns>
        [HttpGet("ArchiveDocument/{id}/readText")]
        public async Task<IActionResult> ReadTextArchiveDocument(Guid id)
        {
            var commnad = new DownloadArchiveDocumentCommand
            {
                Id = id,
